            ...
            {services.map((item, idx) => {
              ...
              return (
                <motion.button
                  ...
                  className={`w-full text-left p-4 sm:p-5 rounded-2xl border transition-all duration-300 flex items-start gap-4 cursor-pointer relative overflow-hidden ${isActive
                ...
                >
                  ...
                  <div
                    className={`p-2.5 rounded-xl border transition-colors shrink-0 ${isActive
